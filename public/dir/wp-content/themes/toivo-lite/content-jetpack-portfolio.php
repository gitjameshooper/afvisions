<?php
/**
 * The template for displaying Jetpack Portfolio content.
 *
 * @package Toivo Lite
 */
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php hybrid_attr( 'post' ); ?>>
	...
	<div class="entry-inner">
		...
		<footer class="entry-footer">
			<?php toivo_lite_post_terms( array( 'taxonomy' => 'jetpack-portfolio-type', 'text' => __( 'Portfolio in %s', 'toivo-lite' ) ) ); ?>
			<?php toivo_lite_post_terms( array( 'taxonomy' => 'jetpack-portfolio-tag', 'text' => __( 'Tagged %s', 'toivo-lite' ), 'before' => '<br />' ) ); ?>
		</footer><!-- .entry-footer -->
